...
class product_typeSeeder extends Seeder {
    public function run() {
        DB::table('type_products')->insert(
                ['name' => 'Ford', 'description' => '', 'image' => 'ford_escape.jpg'],
                ['name' => 'Honda', 'description' => '', 'image' => 'honda_crv.jpg'],
                ['name' => 'Hyundai', 'description' => '', 'image' => 'hyundai_santafe.jpg'],
                ['name' => 'Kia', 'description' => '', 'image' => 'kia_cerato.jpg'],
                ['name' => 'Mazda', 'description' => '', 'image' => 'mazda_mx5.jpg']);
    }
}
