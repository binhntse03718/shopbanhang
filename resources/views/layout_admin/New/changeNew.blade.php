...
<body>
    ...
    <div class="body">
        ...
        <div class="content container">
            @include('errors')
            <div class="">
                <p class="h2">Change New with ID : <small>{{ $new->id }}</small></p>
            </div>
            <div class="form-input">
                <form action="/admin/new/changeNew/{{ $new->id }}" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <p class="h4">Title</p>
                        <input name="title" class="input1" type="text" placeholder="Nhập tên title" value="{{ $new->title }}">
                    </div>
                    <div class="form-group" div class="form-group">
                        <p class="h4">Content</p>
                        <textarea name="content" type="text" placeholder="Nhập nội dung bài viết"
                            style="width: 300px; height: 150px;">{{ $new->content }}</textarea>
                    </div>
                    <div class="form-group">
                        <p class="h4">Image</p>
